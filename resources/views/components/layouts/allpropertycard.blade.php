...
<div class="col-xs-12 col-sm-6 col-md-6 col-lg-4">
    <div class="property-item mb-30">
        <a href="/detail/{{$property->slug}}" class="">
            <div
                class="status-tag" @style('background:'.$background)>
                FOR {{strtoupper($property->listing_type)}}
            </div>
            <img src="/storage/{{ $property->property_thumbnail[0] ?? asset('images/img_1.jpg')}}" alt="Image"
                 class="w-100 shadow-1-strong rounded mb-4" height="500"/>
        </a>
